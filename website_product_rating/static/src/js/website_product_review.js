...
return $(this).each(
function() {
	var total_reviews = document.getElementById('total_product_review');
	var product_rate_value = parseInt(document.getElementById('product_average').innerHTML);
...
$(document).ready(function(){	
	//var t_comment1 = document.getElementById("total_product_review").value;	
    ...
    var t_comment1 = t_comment1.value;

	//console.log("@@@@@@@@@t_comment1@@@@@@@",t_comment1);	
	
	var total_product_review_page=Math.ceil(t_comment1/10);	
	if ( t_comment1 > 10) {
	$("#demo5").paginate({
		count 		: total_product_review_page,
		start 		: 1,
		display     : 3,
		border					: true,
		border_color			: '#000',
